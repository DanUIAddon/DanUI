...
-- DUI: exposed so LFGFilterSkin can read a dropdown's entries and drive them
-- through DanUI's own scroll dropdown instead of this popup menu.
PGF.PopupMenus = popupMenus
