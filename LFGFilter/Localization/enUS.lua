...
L["dialog.delvetier"]  = "Delve Tier ........................."
L["dialog.delvetier.tooltip"] = "Some players do not set the delve tier correctly, but only mention it in the group name. Addons cannot read the name. Use the standard search field for better results."
...
L["dialog.usepgf.results.restricted"] = "|cffff8800The client is not letting PGF read these search results, so no filtering or sorting is being applied.|r"
...
L["dialog.filters.delves"] = "Delves"
...
L["dialog.notdeclined.tooltip"] = "Hide groups that declined you."
...
L["settings.signUpDeclined.title"] = "Apply to declined groups"
L["settings.signUpDeclined.tooltip"] = "Restore the old behavior before TWW and allow to sign up to groups that previously declined you."
L["settings.section.mythicplus.title"] = "Mythic+"
L["settings.section.signup.title"] = "Sign Up"
L["settings.rioRatingColors.title"] = "Rating in Raider.IO Colors"
...
L["settings.groupAge.tooltip"] = "Shows the age of a group to the left of the playstyle. Cannot be used together with compact list entries."
